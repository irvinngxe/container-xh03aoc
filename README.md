...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xh03aoc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xh03aoc.containers.anotherwebservice.com/
...
```
git clone git@github.com:irvinngxe/container-xh03aoc.git
cd container-xh03aoc
```
...
```
docker attach container-xh03aoc
```
